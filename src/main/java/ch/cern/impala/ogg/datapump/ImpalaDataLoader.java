...
public class ImpalaDataLoader {
	...
	public static void main(String[] args) throws Exception {
		...
		TableDefinition tableDef = TableDefinition.createFromFile(prop.getDefinitionFile()); 
		
		//Get control file which is generated by OGG
		ControlFile sourceControlFile = prop.getSourceContorlFile(tableDef);
		...
		ITable targetTable = impC.createTable(tableDef); 
