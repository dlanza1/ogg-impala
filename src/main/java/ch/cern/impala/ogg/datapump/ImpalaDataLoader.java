...
public class ImpalaDataLoader {
	...
	public static void main(String[] args) throws Exception {
		...
		TableDefinition targetTableDef = TableDefinition.create(prop);
		TableDefinition stagingTableDef = targetTableDef.getDefinitionForStagingTable(); 
		...
		ControlFile sourceControlFile = prop.getSourceContorlFile(stagingTableDef);
		...
		impC.createTable(targetTableDef); 
		
		//Period of time for checking new data
		long ms_between_batches = prop.getTimeBetweenBatches();
		...
		//Checking periodically for new data
		while(true){
			...
			if(controlFile != null){
				...
				Batch batch = new Batch(local, hdfs, controlFile, impC, 
											stagingHDFSDirectory, stagingTableDef, 
											targetTableDef);
				batch.start();
				batch.clean();
			}else{
